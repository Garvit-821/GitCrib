import { GitHubDataPayload } from './types.js';
...
const mockPayload: GitHubDataPayload = {
  profile: {
    name: 'Garvit Prakash',
    username: 'Garvit-821',
...
async function testEngine() {
  ...
  const viewports: ('instagram-post' | 'instagram-portrait' | 'twitter-post' | 'poster' | '4k' | 'mobile')[] = [
    'instagram-post',
    'instagram-portrait',
    'twitter-post',
    'poster',
