...
import { ProfileHeader, GradeCard, SimpleMetricCard, StreakCard, ContributionGraph, LanguagesDonut, ReposList, ActivitySummary, CalendarHeatmap, PushBarChart, SocialStrip, FooterBlocks } from './DataBlocks.js';
const themeMap = {
    blueprint: {
        bg: '#05050a',
        grid: '#1b1432',
...
export const Poster = ({ username = 'Garvit-821', name = 'GARVIT PRAKASH', avatarUrl = 'https://avatars.githubusercontent.com/u/77626922?v=4', bio = 'Building the future, one commit at a time.', joinedDate = 'Jan 19, 2021', followers = 18, following = 12, stars = 68, commits = 130, prs = 5, issues = 0, contributedTo = 0, devClass = 'Senior Core Engineer', grade = 'B-', totalContributions = 251, currentStreak = 10, longestStreak = 10, streakDateRange = 'Jun 25 - Jul 4', longestStreakDateRange = 'Jan 25 - Jul 4', contributionsHistory = [2, 5, 3, 8, 2, 4, 12, 18, 5, 9, 14, 8, 12, 5, 7], languages = [
    ...
    return (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: `0 0 ${width} ${height}`, width: "100%", height: "100%", style: { background: colors.bg, fontFamily: '"JetBrains Mono", monospace' }, children: [_jsxs("defs", { children: [_jsx("style", { dangerouslySetInnerHTML: { __html: `
        ...
        ` } }), _jsxs("linearGradient", { id: "chart-area-gradient", x1: "0%", y1: "0%", x2: "0%", y2: "100%", children: [_jsx("stop", { offset: "0%", stopColor: colors.stroke, stopOpacity: "0.35" }), _jsx("stop", { offset: "100%", stopColor: colors.stroke, stopOpacity: "0" })] }), _jsxs("pattern", { id: "poster-grid", width: "40", height: "40", patternUnits: "userSpaceOnUse", children: [_jsx("rect", { width: "40", height: "40", fill: "none" }), _jsx("path", { d: "M 40 0 L 0 0 0 40", fill: "none", stroke: colors.grid, strokeWidth: "0.5", strokeOpacity: "0.04" })] })] }), _jsx("circle", { cx: "0", cy: "0", r: "0", class: "radar-beam", fill: "none" }), _jsx("rect", { width: width, height: height, fill: "url(#poster-grid)" }), _jsx("rect", { x: "15", y: "15", width: width - 30, height: height - 30, fill: "none", stroke: colors.stroke, strokeWidth: "0.5", strokeOpacity: "0.1" }), _jsx("rect", { x: "20", y: "20", width: width - 40, height: height - 40, fill: "none", stroke: colors.stroke, strokeWidth: "1", strokeOpacity: "0.2" }), layout === 'banner' ? (_jsxs(Fragment, { children: [_jsx("g", { transform: "translate(40, 40)", children: _jsx(ProfileHeader, { username: username, name: name, avatarUrl: avatarUrl, bio: bio, joinedDate: joinedDate, devClass: devClass, colors: colors, width: 700, height: 130 }) }), _jsx("g", { transform: "translate(820, 40)", children: _jsx(LanguagesDonut, { languages: languages.slice(0, 3), colors: colors }) }), _jsxs("g", { transform: "translate(40, 355)", children: [_jsx("line", { x1: "0", y1: "0", x2: "1120", y2: "0", stroke: colors.grid, strokeWidth: "0.5", strokeOpacity: "0.4" }), _jsx("text", { x: "0", y: "20", fill: "#666666", fontSize: "10", fontFamily: "monospace", children: "DEVELOPED BY GITHUB.COM/GARVIT-821 // LAUNCHED 2026" }), _jsxs("text", { x: "1120", y: "20", fill: "#666666", fontSize: "10", fontFamily: "monospace", textAnchor: "end", children: ["TIMESTAMP: ", timestamp] })] })] })) : (_jsxs(Fragment, { children: [_jsx("g", { id: "header-block", transform: "translate(40, 55)", children: _jsx(ProfileHeader, { username: username, name: name, avatarUrl: avatarUrl, bio: bio, joinedDate: joinedDate, devClass: devClass, colors: colors, location: location, websiteUrl: websiteUrl, followers: followers, following: following, hireable: username === 'Garvit-821' }) }), _jsxs("g", { id: "metrics-grid", children: [_jsx("g", { transform: "translate(40, 205)", children: _jsx(GradeCard, { grade: grade, colors: colors }) }), _jsx("g", { transform: "translate(204, 205)", children: _jsx(SimpleMetricCard, { value: stars, label: "Total Stars", colors: colors }) }), _jsx("g", { transform: "translate(368, 205)", children: _jsx(SimpleMetricCard, { value: commits, label: "Total Commits", subLabel: "Last Year", colors: colors }) }), _jsx("g", { transform: "translate(532, 205)", children: _jsx(SimpleMetricCard, { value: prs, label: "Total PRs", colors: colors }) }), _jsx("g", { transform: "translate(696, 205)", children: _jsx(SimpleMetricCard, { value: totalContributions, label: "Total Contributions", subLabel: joinedDate + " - Present", colors: colors }) }), _jsx("g", { transform: "translate(860, 205)", children: _jsx(StreakCard, { title: "Current Streak", value: currentStreak, dateRange: streakDateRange, isCurrent: true, colors: colors }) }), _jsx("g", { transform: "translate(1024, 205)", children: _jsx(StreakCard, { title: "Longest Streak", value: longestStreak, dateRange: longestStreakDateRange, isCurrent: false, colors: colors }) })] }), _jsx("g", { transform: "translate(40, 335)", children: _jsx(ContributionGraph, { history: contributionsHistory, colors: colors }) }), _jsx("g", { id: "central-radial-heatmap", transform: "translate(610, 335)", children: _jsx(CalendarHeatmap, { commitData: commitData, colors: colors, isGreen: true, title: "CONTRIBUTIONS IN THE LAST YEAR" }) }), _jsx("g", { id: "language-spectrogram", transform: "translate(40, 575)", children: _jsx(LanguagesDonut, { languages: languages, colors: colors }) }), _jsx("g", { transform: "translate(400, 575)", children: _jsx(ReposList, { repos: repos, totalReposCount: totalReposCount, colors: colors }) }), _jsx("g", { transform: "translate(760, 575)", children: _jsx(ActivitySummary, { pullRequests: activityPRs, issuesOpened: activityIssuesOpened, issuesClosed: activityIssuesClosed, reposContributed: activityReposContributed, reposOwned: activityReposOwned, totalWatchers: activityTotalWatchers, colors: colors }) }), _jsx("g", { transform: "translate(40, 915)", children: _jsx(CalendarHeatmap, { commitData: commitData, colors: colors, isGreen: false, title: "COMMIT ACTIVITY (LAST 12 MONTHS)" }) }), _jsx("g", { transform: "translate(610, 915)", children: _jsx(PushBarChart, { pushHistory: pushHistory, colors: colors }) }), _jsx("g", { transform: "translate(40, 1155)", children: _jsx(SocialStrip, { reviews: reviews, starsGiven: starsGiven, gists: gists, orgs: orgs, projects: projects, packages: packages, colors: colors }) }), _jsx("g", { transform: "translate(40, 1265)", children: _jsx(FooterBlocks, { aboutText: aboutText, portfolioUrl: portfolioUrl, websiteUrl: websiteUrl, email: email, location: location, colors: colors, badges: badges }) }), _jsxs("g", { transform: "translate(40, 1530)", children: [_jsx("line", { x1: "0", y1: "0", x2: "1120", y2: "0", stroke: colors.grid, strokeWidth: "0.5", strokeOpacity: "0.4" }), _jsxs("text", { x: "0", y: "24", fill: "#666666", fontSize: "11", fontFamily: "monospace", children: ["Last Updated: ", timestamp] }), _jsxs("text", { x: "1120", y: "24", fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", textAnchor: "end", children: ["Made with ", _jsx("tspan", { fill: colors.stroke, children: "\uD83D\uDC9C" }), " by Garvit Prakash"] })] })] }))] }));
};
