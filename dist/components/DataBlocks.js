...
export const SimpleMetricCard = ({ value, label, subLabel, colors }) => {
    return (_jsxs("g", { children: [_jsx("rect", { width: "148", height: "110", rx: "10", fill: colors.cardBg, stroke: colors.grid, strokeWidth: "1" }), _jsx("text", { x: "74", y: "52", fill: "#ffffff", fontSize: "28", fontFamily: "monospace", fontWeight: "900", textAnchor: "middle", children: value }), _jsx("text", { x: "74", y: "80", fill: colors.stroke, fontSize: "9", fontFamily: "sans-serif", fontWeight: "700", textAnchor: "middle", children: label }), subLabel && (_jsx("text", { x: "74", y: "96", fill: "#888888", fontSize: "8", fontFamily: "monospace", textAnchor: "middle", children: subLabel }))] }));
};
