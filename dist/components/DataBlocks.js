...
const Icons = {
    ...
    calendar: _jsx("path", { d: "M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z", fill: "currentColor" }),
    briefcase: _jsx("path", { d: "M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z", fill: "currentColor" }),
    clock: _jsx("path", { d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z", fill: "currentColor" })
};
// Tech Logo SVG paths
const TechLogos = {
...
export const ProfileHeader = ({ username, name, avatarUrl, bio, joinedDate, devClass, colors, width = 1120, height = 130, location = 'Delhi, India', websiteUrl = 'dev.gpdev.in', followers = 18, following = 12, hireable = true }) => {
    const avatarCX = 460;
    const avatarCY = 65;
    let displayWeb = websiteUrl;
    if (displayWeb.startsWith('http://'))
        displayWeb = displayWeb.substring(7);
    if (displayWeb.startsWith('https://'))
        displayWeb = displayWeb.substring(8);
    if (displayWeb.endsWith('/'))
        displayWeb = displayWeb.substring(0, displayWeb.length - 1);
    return (_jsxs("g", { id: "header-block", children: [_jsx("text", { x: "40", y: "45", fill: "#ffffff", fontSize: "36", fontFamily: "sans-serif", fontWeight: "800", letterSpacing: "-1", children: "DEVELOPER WORKSPACE" }), _jsx("text", { x: "40", y: "85", fill: colors.stroke, fontSize: "28", fontFamily: "sans-serif", fontWeight: "800", letterSpacing: "-1", children: "GITHUB ANALYTICS" }), _jsx("text", { x: "40", y: "112", fill: colors.accent1, fontSize: "11", fontFamily: "monospace", fontWeight: "800", letterSpacing: "1.5", children: "CODE. COMMIT. CONQUER." }), _jsx("defs", { children: _jsx("clipPath", { id: "avatar-clip", children: _jsx("circle", { cx: avatarCX, cy: avatarCY, r: "45" }) }) }), _jsx("circle", { cx: avatarCX, cy: avatarCY, r: "48", fill: "none", stroke: colors.stroke, strokeWidth: "2.5" }), _jsx("image", { href: avatarUrl || 'https://avatars.githubusercontent.com/u/9919?v=4', x: avatarCX - 45, y: avatarCY - 45, width: "90", height: "90", clipPath: "url(#avatar-clip)" }), _jsx("text", { x: "530", y: "50", fill: "#ffffff", fontSize: "22", fontFamily: "sans-serif", fontWeight: "700", children: name || username }), _jsxs("text", { x: "530", y: "68", fill: colors.accent1, fontSize: "11", fontFamily: "monospace", fontWeight: "500", children: ["@", username.toUpperCase()] }), devClass && (_jsx("text", { x: "530", y: "82", fill: colors.stroke, fontSize: "9", fontFamily: "monospace", fontWeight: "600", letterSpacing: "0.5", children: devClass.toUpperCase() })), (() => {
                const wrapBio = (text, maxLen = 32) => {
                    if (!text)
                        return [];
                ...
                return bioLines.map((line, idx) => (_jsx("text", { x: "530", y: 100 + idx * 13, fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", children: line }, idx)));
            })(), _jsxs("g", { transform: "translate(810, 25)", children: [_jsxs("g", { transform: "translate(0, 0)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", style: { color: colors.stroke }, children: Icons.calendar }), _jsx("text", { x: "22", y: "11", fill: "#a8a8a8", fontSize: "10", fontFamily: "sans-serif", children: "Joined GitHub" }), _jsx("text", { x: "22", y: "25", fill: "#ffffff", fontSize: "10", fontFamily: "monospace", fontWeight: "bold", children: joinedDate || 'Jan 19, 2021' })] }), _jsxs("g", { transform: "translate(0, 36)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", style: { color: colors.stroke }, children: Icons.location }), _jsx("text", { x: "22", y: "11", fill: "#a8a8a8", fontSize: "10", fontFamily: "sans-serif", children: "Location" }), _jsx("text", { x: "22", y: "25", fill: "#ffffff", fontSize: "10", fontFamily: "sans-serif", fontWeight: "bold", children: location || 'Delhi, India' })] }), _jsxs("g", { transform: "translate(0, 72)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", style: { color: colors.stroke }, children: Icons.globe }), _jsx("text", { x: "22", y: "11", fill: "#a8a8a8", fontSize: "10", fontFamily: "sans-serif", children: "Website" }), _jsx("text", { x: "22", y: "25", fill: "#ffffff", fontSize: "10", fontFamily: "monospace", fontWeight: "bold", children: displayWeb || 'dev.gpdev.in' })] })] }), _jsxs("g", { transform: "translate(980, 25)", children: [_jsxs("g", { transform: "translate(0, 0)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", style: { color: colors.stroke }, children: Icons.people }), _jsx("text", { x: "22", y: "11", fill: "#a8a8a8", fontSize: "10", fontFamily: "sans-serif", children: "Followers / Following" }), _jsxs("text", { x: "22", y: "25", fill: "#ffffff", fontSize: "10", fontFamily: "monospace", fontWeight: "bold", children: [followers, " / ", following] })] }), _jsxs("g", { transform: "translate(0, 36)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", style: { color: colors.stroke }, children: Icons.briefcase }), _jsx("text", { x: "22", y: "11", fill: "#a8a8a8", fontSize: "10", fontFamily: "sans-serif", children: "Hireable" }), _jsx("text", { x: "22", y: "25", fill: colors.accent2, fontSize: "10", fontFamily: "sans-serif", fontWeight: "bold", children: hireable ? 'Yes' : 'No' })] }), _jsxs("g", { transform: "translate(0, 72)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", style: { color: colors.stroke }, children: Icons.clock }), _jsx("text", { x: "22", y: "11", fill: "#a8a8a8", fontSize: "10", fontFamily: "sans-serif", children: "Profile" }), _jsxs("text", { x: "22", y: "25", fill: "#ffffff", fontSize: "10", fontFamily: "monospace", fontWeight: "bold", children: ["github.com/", username] })] })] })] }));
};
...
export const GradeCard = ({ grade = 'B-', colors }) => {
    ...
    return (_jsxs("g", { children: [_jsx("rect", { width: "148", height: "110", rx: "10", fill: colors.cardBg, stroke: colors.grid, strokeWidth: "1" }), _jsx("circle", { cx: cx, cy: cy, r: radius, fill: "none", stroke: colors.grid, strokeWidth: "6", strokeOpacity: "0.2" }), _jsx("circle", { cx: cx, cy: cy, r: radius, fill: "none", stroke: colors.stroke, strokeWidth: "6", strokeDasharray: circ.toFixed(1), strokeDashoffset: getOffset(grade).toFixed(1), strokeLinecap: "round", transform: `rotate(-90 ${cx} ${cy})` }), _jsx("text", { x: cx, y: cy + 6, fill: "#ffffff", fontSize: "18", fontFamily: "monospace", fontWeight: "900", textAnchor: "middle", children: grade }), _jsx("text", { x: "74", y: "90", fill: colors.stroke, fontSize: "9", fontFamily: "sans-serif", fontWeight: "700", textAnchor: "middle", children: "GitHub Grade" })] }));
};
export const SimpleMetricCard = ({ value, label, subLabel, colors }) => {
    return (_jsxs("g", { children: [_jsx("rect", { width: "148", height: "110", rx: "10", fill: colors.cardBg, stroke: colors.grid, strokeWidth: "1" }), _jsx("text", { x: "74", y: "52", fill: "#ffffff", fontSize: "28", fontFamily: "monospace", fontWeight: "900", textAnchor: "middle", children: formatNum(value) }), _jsx("text", { x: "74", y: "80", fill: colors.stroke, fontSize: "9", fontFamily: "sans-serif", fontWeight: "700", textAnchor: "middle", children: label }), subLabel && (_jsx("text", { x: "74", y: "96", fill: "#888888", fontSize: "8", fontFamily: "monospace", textAnchor: "middle", children: subLabel }))] }));
};
export const StreakCard = ({ title, value, dateRange, isCurrent, colors }) => {
    return (_jsxs("g", { children: [_jsx("rect", { width: "148", height: "110", rx: "10", fill: colors.cardBg, stroke: colors.grid, strokeWidth: "1" }), _jsx("svg", { x: "120", y: "10", width: "16", height: "16", viewBox: "0 0 24 24", style: { color: colors.accent1 }, children: isCurrent ? Icons.flame : Icons.medal }), _jsx("text", { x: "74", y: "52", fill: "#ffffff", fontSize: "28", fontFamily: "monospace", fontWeight: "900", textAnchor: "middle", children: value }), _jsx("text", { x: "74", y: "80", fill: colors.stroke, fontSize: "9", fontFamily: "sans-serif", fontWeight: "700", textAnchor: "middle", children: title }), _jsx("text", { x: "74", y: "96", fill: "#888888", fontSize: "8", fontFamily: "monospace", textAnchor: "middle", children: dateRange })] }));
};
...
export const CalendarHeatmap = ({ commitData = [], colors, isGreen = false, title = 'COMMIT ACTIVITY (LAST 12 MONTHS)' }) => {
    const width = 550;
    const height = 220;
    ...
    const getFill = (val) => {
        if (isGreen) {
            if (val === 0)
                return '#161b22'; // Standard GitHub dark empty cell
            if (val < 3)
                return '#0e4429';
            if (val < 6)
                return '#006d32';
    ...
    return (_jsxs("g", { id: "central-radial-heatmap", children: [_jsx("rect", { width: width, height: height, rx: "12", fill: colors.cardBg, stroke: colors.grid, strokeWidth: "1" }), _jsx("text", { x: "25", y: "35", fill: colors.stroke, fontSize: "13", fontFamily: "sans-serif", fontWeight: "800", children: title }), _jsx("text", { x: "25", y: startY + colSize * 1 + 5, fill: "#666666", fontSize: "9", fontFamily: "monospace", children: "Mon" }), _jsx("text", { x: "25", y: startY + colSize * 3 + 5, fill: "#666666", fontSize: "9", fontFamily: "monospace", children: "Wed" }), _jsx("text", { x: "25", y: startY + colSize * 5 + 5, fill: "#666666", fontSize: "9", fontFamily: "monospace", children: "Fri" }), months.map((m, i) => {
            ...
            }), gridElements, _jsxs("g", { transform: "translate(380, 172)", children: [_jsx("text", { x: "-10", y: "8", fill: "#666666", fontSize: "9", fontFamily: "monospace", textAnchor: "end", children: "Less" }), _jsx("rect", { x: "0", y: "0", width: "8", height: "8", rx: "1", fill: isGreen ? '#161b22' : '#161426' }), _jsx("rect", { x: "10", y: "0", width: "8", height: "8", rx: "1", fill: isGreen ? '#0e4429' : '#3b2075' }), _jsx("rect", { x: "20", y: "0", width: "8", height: "8", rx: "1", fill: isGreen ? '#006d32' : '#6230c0' }), _jsx("rect", { x: "30", y: "0", width: "8", height: "8", rx: "1", fill: isGreen ? '#26a641' : '#7b3aed' }), _jsx("rect", { x: "40", y: "0", width: "8", height: "8", rx: "1", fill: isGreen ? '#39d353' : '#a855f7' }), _jsx("text", { x: "55", y: "8", fill: "#666666", fontSize: "9", fontFamily: "monospace", children: "More" })] })] }));
};
...
export const AchievementsList = ({ badges = [], colors }) => {
    ...
    return (_jsx("g", { children: displayBadges.map((b, idx) => {
            const y = idx * 40;
            const color = b.level === 'gold' ? '#f59e0b' : (b.level === 'silver' ? '#94a3b8' : '#b45309');
            const firstLetter = b.name ? b.name[0] : '★';
            return (_jsxs("g", { transform: `translate(0, ${y})`, children: [_jsx("circle", { cx: "12", cy: "16", r: "12", fill: color, fillOpacity: "0.15", stroke: color, strokeWidth: "1" }), _jsx("text", { x: "12", y: "20", fill: color, fontSize: "10", fontFamily: "sans-serif", fontWeight: "900", textAnchor: "middle", children: firstLetter }), _jsx("text", { x: "32", y: "14", fill: "#ffffff", fontSize: "10", fontFamily: "sans-serif", fontWeight: "bold", children: b.name.toUpperCase() }), _jsx("text", { x: "32", y: "26", fill: "#a8a8a8", fontSize: "8", fontFamily: "sans-serif", children: b.description.length > 34 ? b.description.substring(0, 32) + '..' : b.description })] }, `badge-${idx}`));
        }) }));
};
export const FooterBlocks = ({ aboutText, portfolioUrl, websiteUrl, email, location, colors, badges = [] }) => {
    return (_jsxs("g", { children: [_jsxs("g", { transform: "translate(0, 0)", children: [_jsx("text", { x: "0", y: "0", fill: colors.stroke, fontSize: "13", fontFamily: "sans-serif", fontWeight: "800", children: "ACHIEVEMENTS" }), _jsx("g", { transform: "translate(0, 20)", children: _jsx(AchievementsList, { badges: badges, colors: colors }) })] }), _jsxs("g", { transform: "translate(280, 0)", children: [_jsx("text", { x: "0", y: "0", fill: colors.stroke, fontSize: "13", fontFamily: "sans-serif", fontWeight: "800", children: "TECH STACK" }), _jsx("g", { transform: "translate(0, 25)", children: ['html', 'css', 'javascript', 'react', 'node', 'python'].map((tech, i) => {
                            const x = i * 40;
                            return (_jsxs("g", { transform: `translate(${x}, 0)`, children: [_jsx("rect", { width: "32", height: "32", rx: "5", fill: "#131122" }), _jsx("g", { transform: "translate(4, 4) scale(1)", children: _jsx("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: TechLogos[tech] }) })] }, `tech-${tech}`));
                        }) }), _jsx("g", { transform: "translate(0, 75)", children: ['typescript', 'git', 'github', 'vercel', 'figma'].map((tech, i) => {
                            const x = i * 40;
                            return (_jsxs("g", { transform: `translate(${x}, 0)`, children: [_jsx("rect", { width: "32", height: "32", rx: "5", fill: "#131122" }), _jsx("g", { transform: "translate(4, 4) scale(1)", children: _jsx("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: TechLogos[tech] }) })] }, `tech-${tech}`));
                        }) })] }), _jsxs("g", { transform: "translate(580, 0)", children: [_jsx("text", { x: "0", y: "0", fill: colors.stroke, fontSize: "13", fontFamily: "sans-serif", fontWeight: "800", children: "ABOUT" }), _jsx("text", { x: "0", y: "24", fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", children: (() => {
                            ...
                            if (currentLine)
                                lines.push(currentLine);
                            return lines.slice(0, 3).map((line, idx) => (_jsx("tspan", { x: "0", dy: idx === 0 ? 0 : 15, children: line }, idx)));
                        })() }), _jsxs("g", { transform: "translate(0, 70)", children: [_jsx("rect", { width: "240", height: "90", rx: "6", fill: "#040308", stroke: colors.grid, strokeWidth: "0.5" }), _jsx("text", { x: "15", y: "25", fill: colors.accent1, fontSize: "11", fontFamily: "monospace", children: "while" }), _jsx("text", { x: "48", y: "25", fill: "#ffffff", fontSize: "11", fontFamily: "monospace", children: "(alive) {" }), _jsx("text", { x: "30", y: "42", fill: colors.stroke, fontSize: "11", fontFamily: "monospace", children: "code();" }), _jsx("text", { x: "30", y: "58", fill: colors.stroke, fontSize: "11", fontFamily: "monospace", children: "sleep();" }), _jsx("text", { x: "30", y: "74", fill: colors.stroke, fontSize: "11", fontFamily: "monospace", children: "repeat();" }), _jsx("text", { x: "15", y: "90", fill: "#ffffff", fontSize: "11", fontFamily: "monospace", children: "}" })] })] }), _jsxs("g", { transform: "translate(880, 0)", children: [_jsx("text", { x: "0", y: "0", fill: colors.stroke, fontSize: "13", fontFamily: "sans-serif", fontWeight: "800", children: "CONNECT" }), _jsxs("g", { transform: "translate(0, 22)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", style: { color: colors.accent1 }, children: Icons.globe }), _jsx("text", { x: "20", y: "11", fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", children: "Portfolio:" }), _jsx("text", { x: "75", y: "11", fill: "#ffffff", fontSize: "11", fontFamily: "monospace", children: portfolioUrl })] }), _jsxs("g", { transform: "translate(0, 52)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", style: { color: colors.accent1 }, children: Icons.globe }), _jsx("text", { x: "20", y: "11", fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", children: "Website:" }), _jsx("text", { x: "75", y: "11", fill: "#ffffff", fontSize: "11", fontFamily: "monospace", children: websiteUrl })] }), _jsxs("g", { transform: "translate(0, 82)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", style: { color: colors.accent1 }, children: Icons.mail }), _jsx("text", { x: "20", y: "11", fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", children: "Email:" }), _jsx("text", { x: "75", y: "11", fill: "#ffffff", fontSize: "11", fontFamily: "monospace", children: email })] }), _jsxs("g", { transform: "translate(0, 112)", children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", style: { color: colors.accent1 }, children: Icons.location }), _jsx("text", { x: "20", y: "11", fill: "#a8a8a8", fontSize: "11", fontFamily: "sans-serif", children: "Location:" }), _jsx("text", { x: "75", y: "11", fill: "#ffffff", fontSize: "11", fontFamily: "sans-serif", children: location })] })] })] }));
};
